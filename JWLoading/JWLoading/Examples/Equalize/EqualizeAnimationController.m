...
#import "EqualizeAnimationController.h"

#import "JWLoading.h"

@interface EqualizeAnimationController ()

@end

@implementation EqualizeAnimationController
...
- (void)viewDidLoad {
    ...
    JWLoadingEqualize *tempLoading = [JWLoadingEqualize new];
