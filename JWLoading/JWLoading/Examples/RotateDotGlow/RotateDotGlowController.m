...
#import "RotateDotGlowController.h"

#import "JWLoading.h"

@interface RotateDotGlowController ()

@end

@implementation RotateDotGlowController
...
- (void)viewDidLoad {
    ...
    JWLoadingRotatedotglow *tempLoading = [JWLoadingRotatedotglow new];
